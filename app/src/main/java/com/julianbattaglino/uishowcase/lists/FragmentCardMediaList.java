...
import com.julianbattaglino.uishowcase.adapters.GoogleCardsMediaAdapter;
...
public class FragmentCardMediaList extends Fragment implements OnDismissCallback {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsMediaAdapter(getActivity(),
