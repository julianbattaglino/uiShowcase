...
import com.julianbattaglino.uishowcase.adapters.GoogleCardsTravelAdapter;
...
public class FragmentCardTravelList extends Fragment implements OnDismissCallback {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsTravelAdapter(getActivity(),
                DummyContent2.getDummyModelGoogleCardsTravelList());
