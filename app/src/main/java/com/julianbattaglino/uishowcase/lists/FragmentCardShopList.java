...
import com.julianbattaglino.uishowcase.adapters.GoogleCardsShopAdapter;
...
public class FragmentCardShopList extends Fragment implements OnDismissCallback {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsShopAdapter(getActivity(),
