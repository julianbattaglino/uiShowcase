 ...
 */
public class FragmentAnimation5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v = localInflater.inflate(R.layout.fragment_animation_5, null);
...
*/
        changecolor = getView().findViewById(R.id.changecolor);


        AnimationUtils.rotateXwithColor(changecolor, 0xff444444, 800);
        AnimationUtils.rotateXwithColor(changecolor, 0xff000000, 2400);
        AnimationUtils.rotateXwithColor(changecolor, 0xffffffff, 4000);
